  ...
  return (
    <>
      <div className="flex grid xl:grid-cols-4 sm:flex gap-5 sm:gap-5 p-5">
        <Card title="Total Users" className="card w-full md:w-1/2 ">
          <h1>{userCount}</h1>
        </Card>

        <Card title="Total Podcasts" className="card w-full md:w-1/2">
          <h1>{fileCount}</h1>
        </Card>
        <Card title="Total Products" className="card w-full md:w-1/2">
          <h1>100</h1>
        </Card>
        <Card title="Total Categories" className="card w-full md:w-1/2">
          <h1>100</h1>
        </Card>
      </div>
